...
void SceneManager::DefineObjectMaterials()
{
	...
	goldMaterial.specularColor = glm::vec3(0.65f, 0.65f, 0.65f);
...
void SceneManager::SetupSceneLights()
{
	...
	// point light 1
	m_pShaderManager->setVec3Value("pointLights[0].position", 5.0f, 9.0f, -5.0f);
	m_pShaderManager->setVec3Value("pointLights[0].ambient", 1.0f, 1.0f, 1.0f);
	m_pShaderManager->setVec3Value("pointLights[0].diffuse", 0.97, 0.90, 0.56);
	m_pShaderManager->setVec3Value("pointLights[0].specular", 0.97f, 0.83f, 0.29f);
...
// set the XYZ scale for the mesh
	...
	/****************************************************************/
		...
		// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(.7f, 0.6f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(5.6f, 1.3f, 1.9f);
...
// set the XYZ scale for the mesh
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.5f, 1.3f, 1.7f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(1.5f, 5.5f, -2.0f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(5.0f, 0.08f, 5.46f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(1.7f, 6.0f, 0.3f);
	...
	/****************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.7f, -0.2f, 0.7f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-1.0f, 1.8f, 7.1f);
	...
	//SetShaderColor(173, 173, 173, 0.8);
	SetTextureUVScale(1.0, 1.0);
...
// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.5f, 0.0f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-0.15f, 1.8f, 7.89f);
...
// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.50f, 0.0f, 2.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(1.0f,1.81f, 8.89f);
